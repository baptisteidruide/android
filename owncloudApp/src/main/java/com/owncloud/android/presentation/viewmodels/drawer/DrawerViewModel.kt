...
class DrawerViewModel(
    private val getUserQuotaAsyncUseCase: GetUserQuotaAsyncUseCase,
    ...
    fun fetchUserQuota(
        ...
        showLoading = true,
        liveData = _userQuota,
        useCase = getUserQuotaAsyncUseCase,
        useCaseParams = GetUserQuotaAsyncUseCase.Params(accountName = accountName)
    )
